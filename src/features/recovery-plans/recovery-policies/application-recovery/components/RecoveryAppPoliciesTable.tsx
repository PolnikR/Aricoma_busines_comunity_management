...
export function RecoveryAppPoliciesTable({ policies, isLoading, error, isRetrying, onRetry }: RecoveryAppPoliciesTableProps) {
  ...
  return (
    <div className="flex flex-col">
      ...
      <DataTableRequestState error={error ? { title: t('recoveryAppPolicies.loadFailed'), ...(loadErrorDetail ? { description: loadErrorDetail } : {}), retryLabel: t('buttons.retry'), isRetrying, onRetry } : null}>
        <DataTable
