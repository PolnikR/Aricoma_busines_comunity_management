    ...
    <button
      ...
      className={cn(
        ...
        selected
          ...
          : 'border-[#d7e4ef] bg-gradient-to-br from-white to-[#f8fbfe] shadow-[0_12px_30px_-24px_rgba(31,59,91,0.75)] enabled:hover:-translate-y-0.5 enabled:hover:border-[#8bc9ed] enabled:hover:shadow-[0_18px_34px_-22px_rgba(31,96,139,0.55)]',
        className,
      )}
      {...props}
    >
      ...
      <span className="mt-auto flex min-h-7 items-end justify-between gap-3 pt-3">
        ...
        {icon ? (
          <span
            ...
            className="ml-auto shrink-0 text-[#38536e] opacity-80 transition group-[:enabled:hover]:opacity-100"
          >
            {icon}
          </span>
        ) : null}
