...
const controlClassName = 'h-10 w-full min-w-0 max-w-full rounded-xl border border-[#cfdaea] bg-[#fcfdff] px-3 text-sm text-[#273750] shadow-sm outline-none transition placeholder:text-[#9aa8bc] focus:border-[#63bdf2] focus:bg-white focus:ring-4 focus:ring-[#1596dd]/10 disabled:cursor-not-allowed disabled:bg-[#f1f5f9] disabled:text-[#8390a5]'
