      ...
      {items.map((item, index) => {
        ...
        return (
          <button
            ...
            className={`max-w-64 shrink-0 overflow-hidden whitespace-nowrap border-b-2 text-ellipsis font-medium transition ${compact ? 'px-3 py-2.5 text-xs' : 'px-4 py-3.5 text-sm'} ${
              isSelected
                ? indicator === 'inset'
