...
export function Tabs<T extends string>({
  ...
  const scroll = (direction: -1 | 1) => {
    ...
    tabList.scrollBy({
      left: direction * Math.max(160, tabList.clientWidth * 0.8),
      behavior: 'smooth',
    })
  }
      ...
      {items.map((item, index) => {
        ...
        return (
          <button
            ...
            className={`max-w-48 shrink-0 overflow-hidden whitespace-nowrap border-b-2 px-4 py-3.5 text-ellipsis text-sm font-medium transition ${
              isSelected
